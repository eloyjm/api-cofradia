...
def populate_database():
    ...
    db.add(hermandadDR5)
    hermandadDR6 = Hermandad(name="La Hiniesta", day=DayEnum.DR, her_id=6)
    db.add(hermandadDR6)
    hermandadDR7 = Hermandad(name="La Paz", day=DayEnum.DR, her_id=7)
    db.add(hermandadDR7)
    hermandadDR8 = Hermandad(name="San Roque", day=DayEnum.DR, her_id=8)
    db.add(hermandadDR8)


    #Hermandades del lunes
    hermandadLS0 = Hermandad(name="El Museo", day=DayEnum.LS, her_id=0)
    db.add(hermandadLS0)
    hermandadLS1 = Hermandad(name="La Redención", day=DayEnum.LS, her_id=1)
    db.add(hermandadLS1)
    hermandadLS2 = Hermandad(name="Las Aguas", day=DayEnum.LS, her_id=2)
    db.add(hermandadLS2)
    hermandadLS3 = Hermandad(name="Las Penas", day=DayEnum.LS, her_id=3)
    db.add(hermandadLS3)
    hermandadLS4 = Hermandad(name="San Gonzalo", day=DayEnum.LS, her_id=4)
    db.add(hermandadLS4)
    hermandadLS5 = Hermandad(name="San Pablo", day=DayEnum.LS, her_id=5)
    db.add(hermandadLS5)
    hermandadLS6 = Hermandad(name="Santa Genovena", day=DayEnum.LS, her_id=6)
    db.add(hermandadLS6)
    hermandadLS7 = Hermandad(name="Santa Marta", day=DayEnum.LS, her_id=7)
    db.add(hermandadLS7)
    hermandadLS8 = Hermandad(name="Vera Cruz", day=DayEnum.LS, her_id=8)
    db.add(hermandadLS8)
