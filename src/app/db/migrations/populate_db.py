...
def populate_database():
    ...
    db.add(hermandadDR1)
    hermandadDR2 = Hermandad(id=str(uuid.uuid4()), name="La Amargura", day=DayEnum.DR, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Amargura_(Sevilla)", color_one="#ffffff", color_two="#ffffff")
    db.add(hermandadDR2)
    hermandadDR3 = Hermandad(id=str(uuid.uuid4()), name="La Borriquita", day=DayEnum.DR, wiki_url="", color_one="#ffffff", color_two="#ffffff")
    db.add(hermandadDR3)
    hermandadDR4 = Hermandad(id=str(uuid.uuid4()), name="La Cena", day=DayEnum.DR, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Cena_(Sevilla)", color_one="#ffffff", color_two="#ffffff")
    db.add(hermandadDR4)
    ...
    db.add(hermandadDR5)
    hermandadDR6 = Hermandad(id=str(uuid.uuid4()), name="La Hiniesta", day=DayEnum.DR, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Hiniesta_(Sevilla)", color_one="#211e73", color_two="#ffffff")
    db.add(hermandadDR6)
    hermandadDR7 = Hermandad(id=str(uuid.uuid4()), name="La Paz", day=DayEnum.DR, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Paz_(Sevilla)", color_one="#ffffff", color_two="#ffffff")
    db.add(hermandadDR7)
    ...
    db.add(hermandadLS1)
    hermandadLS2 = Hermandad(id=str(uuid.uuid4()), name="Las Aguas", day=DayEnum.LS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_las_Aguas_(Sevilla)", color_one="#5e2e77", color_two="#ffffff")
    db.add(hermandadLS2)
    ...
    db.add(hermandadLS3)
    hermandadLS4 = Hermandad(id=str(uuid.uuid4()), name="San Gonzalo", day=DayEnum.LS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_San_Gonzalo_(Sevilla)", color_one="#ffffff", color_two="#ffffff")
    db.add(hermandadLS4)
    ...
    db.add(hermandadLS5)
    hermandadLS6 = Hermandad(id=str(uuid.uuid4()), name="Santa Genoveva", day=DayEnum.LS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_Santa_Genoveva_(Sevilla)", color_one="#000000", color_two="#ffffff")
    db.add(hermandadLS6)
    ...
    hermandadMS0 = Hermandad(id=str(uuid.uuid4()), name="El Cerro", day=DayEnum.MS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_del_Cerro_(Sevilla)", color_one="#e63939", color_two="#ffffff")
    db.add(hermandadMS0)
    hermandadMS1 = Hermandad(id=str(uuid.uuid4()), name="El Dulce Nombre", day=DayEnum.MS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_del_Dulce_Nombre_(Sevilla)", color_one="#ffffff", color_two="#ffffff")
    db.add(hermandadMS1)
    hermandadMS2 = Hermandad(id=str(uuid.uuid4()), name="La Candelaria", day=DayEnum.MS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Candelaria_(Sevilla)", color_one="#ffffff", color_two="#ffffff")
    db.add(hermandadMS2)
    ...
    db.add(hermandadMS4)
    hermandadMS5 = Hermandad(id=str(uuid.uuid4()), name="San Benito", day=DayEnum.MS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_San_Benito_(Sevilla)", color_one="#5e2e77", color_two="#ffffff")
    db.add(hermandadMS5)
    ...
    db.add(hermandadXS2)
    hermandadXS3 = Hermandad(id=str(uuid.uuid4()), name="El Carmen", day=DayEnum.XS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_del_Carmen_(Sevilla)", color_one="#694d2e", color_two="#ffffff")
    db.add(hermandadXS3)
    ...
    db.add(hermandadXS5)
    hermandadXS6 = Hermandad(id=str(uuid.uuid4()), name="Las Siete Palabras", day=DayEnum.XS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_las_Siete_Palabras_(Sevilla)", color_one="#e63939", color_two="#ffffff")
    db.add(hermandadXS6)
    ...
    db.add(hermandadJS0)
    hermandadJS1 = Hermandad(id=str(uuid.uuid4()), name="La Exaltación", day=DayEnum.JS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Exaltaci%C3%B3n_(Sevilla)", color_one="#5e2e77", color_two="#ffffff")
    db.add(hermandadJS1)
    ...
    db.add(hermandadJS4)
    hermandadJS5 = Hermandad(id=str(uuid.uuid4()), name="Los Negritos", day=DayEnum.JS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_los_Negritos_(Sevilla)", color_one="#ffffff", color_two="#211e73")
    db.add(hermandadJS5)
    hermandadJS6 = Hermandad(id=str(uuid.uuid4()), name="Montesión", day=DayEnum.JS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_Monte-Sion", color_one="#000000", color_two="#ffffff")
    db.add(hermandadJS6)
    ...
    db.add(hermandadM4) 
    hermandadM5 = Hermandad(id=str(uuid.uuid4()), name="Los Gitanos", day=DayEnum.M, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_los_Gitanos_(Sevilla)", color_one="#5e2e77", color_two="#ffffff") 
    db.add(hermandadM5)
    ...
    db.add(hermandadVS3)
    hermandadVS4 = Hermandad(id=str(uuid.uuid4()), name="La Soledad de San Buenaventura", day=DayEnum.VS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Soledad_de_San_Buenaventura_(Sevilla)", color_one="#000000", color_two="#ffffff")
    db.add(hermandadVS4)
    hermandadVS5 = Hermandad(id=str(uuid.uuid4()), name="Montserrat", day=DayEnum.VS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_Montserrat_(Sevilla)", color_one="#211e73", color_two="#ffffff")
    db.add(hermandadVS5)
    ...
    db.add(hermandadSS1)
    hermandadSS2 = Hermandad(id=str(uuid.uuid4()), name="La Soledad De San Lorenzo", day=DayEnum.SS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Soledad_de_San_Lorenzo_(Sevilla)", color_one="#000000", color_two="#ffffff")
    db.add(hermandadSS2)
    hermandadSS3 = Hermandad(id=str(uuid.uuid4()), name="La Trinidad", day=DayEnum.SS, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Trinidad_(Sevilla)", color_one="#000000", color_two="#ffffff")
    db.add(hermandadSS3)
    ...
    hermandadDDR0 = Hermandad(id=str(uuid.uuid4()), name="La Resurrección", day=DayEnum.DDR, wiki_url="https://es.wikipedia.org/wiki/Hermandad_de_la_Resurrecci%C3%B3n_(Sevilla)", color_one="#ffffff", color_two="#ffffff")
